...
void pragmatic_2d_mpi_init(const int *NNodes, const int *NElements, const int *enlist, const double *x, const double *y, const index_t *lnn2gnn, const index_t *NPNodes, MPI_Comm mpi_comm);
...
void pragmatic_3d_mpi_init(const int *NNodes, const int *NElements, const int *enlist, const double *x, const double *y, const double *z, const index_t *lnn2gnn, const index_t *NPNodes, MPI_Comm mpi_comm);
