...
if __name__=="__main__":
 ellipse_convergence(asp=1, octaveimpl=True, width=2e-2)
# ellipse_convergence(asp=1)
 #ellipse_convergence(asp=1,width=1e-1, CGorderL=[2], eta_list=[0.001], problem=1) #for presentation
