...
module pragmatic_metric
  ...
  interface pragmatic_metric_begin
     subroutine pragmatic_metric_2d_begin(NNodes, NElements, enlist, x, y) bind(c,name="pragmatic_metric_2d_begin")
       ...
       real(c_float) :: x(*)
       real(c_float) :: y(*)
     end subroutine pragmatic_metric_2d_begin
     subroutine pragmatic_metric_3d_begin(NNodes, NElements, enlist, x, y, z) bind(c,name="pragmatic_metric_3d_begin")
       use iso_c_binding
       implicit none
       integer(kind=c_int) :: NNodes
       integer(kind=c_int) :: NElements
  ...
  interface pragmatic_metric_end
     subroutine pragmatic_metric_end(metric) bind(c,name="pragmatic_metric_end")
       ...
       implicit none
       real(c_float) :: metric(*)
     end subroutine pragmatic_metric_end
  end interface pragmatic_metric_end
end module pragmatic_metric
